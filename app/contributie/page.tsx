            ...
            <div className="mt-12 grid md:grid-cols-2 gap-5">
              <div className="card p-6">
                ...
                <p className="text-sm text-[color:var(--color-muted)] leading-relaxed">
                  De <a href="https://nbjjv.nl" target="_blank" rel="noopener noreferrer" className="text-[color:var(--color-accent-300)] hover:underline">NBJJV</a> (Nederlandse bond voor jujitsu, judo en vormgeving) brengt jaarlijks €25,00 in rekening voor bondskosten. Verzekering en zwarte band examens lopen via de NBJJV.
                </p>
              </div>
              <div className="card p-6">
