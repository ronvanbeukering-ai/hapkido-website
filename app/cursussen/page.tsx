...
export default async function Page() {
  ...
  let heeftToegang = false, isAdminUser = false, isLidUser = false, heeftZwarteBandToegang = false, heeftAcademieToegang = false;

  if (session?.user) {
    const adminEmail = (process.env.ADMIN_EMAIL ?? "").toLowerCase();
    const userEmail  = (session.user.email ?? "").toLowerCase();
    if (adminEmail && userEmail === adminEmail) {
      heeftToegang = true; isAdminUser = true; isLidUser = true; heeftZwarteBandToegang = true; heeftAcademieToegang = true;
    } else {
  ...
  return (
    <>
      ...
      {/* Promo- en dojang-blok zijn wervend materiaal voor niet-leden — wie al
          toegang heeft moet hier niet doorheen scrollen om bij de lessen/video's
          te komen. */}
      {!heeftToegang && (
        <>
      ...
      <CursusContent
        ...
        heeftAcademieToegang={heeftAcademieToegang}
      />
