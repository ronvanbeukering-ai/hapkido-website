            ...
            <div className="card p-6 md:p-8 space-y-6">
              <div>
                ...
                <div className="mt-2 space-y-2 text-sm text-[color:var(--color-text)]">
                  <a href="https://nbjjv.nl" target="_blank" rel="noopener noreferrer" className="text-[color:var(--color-accent-300)] hover:underline">NBJJV</a>, Nederlandse bond voor jujitsu, judo en vormgeving
                </div>
              </div>
              <div>
